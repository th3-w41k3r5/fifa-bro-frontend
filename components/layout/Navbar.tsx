...
import { Search, LogOut, User, Menu, Trophy, Zap, Calendar, Users, BarChart3, Settings, X } from 'lucide-react';
          ...
          <>
            {sectionsMenuOpen && (
              <>
                ...
                <div className="fixed inset-x-0 bottom-[78px] z-[8100] max-h-[calc(100vh-150px)] overflow-y-auto rounded-t-[28px] border-t border-white/[0.08] bg-[rgba(8,11,16,0.96)] shadow-[0_-24px_60px_rgba(0,0,0,0.48)] backdrop-blur-[36px] md:hidden">
                ...
                <div className="fixed left-1/2 top-28 z-[8100] hidden w-[420px] max-w-[calc(100vw-2rem)] -translate-x-1/2 overflow-hidden rounded-[24px] border border-white/[0.08] bg-[rgba(8,11,16,0.96)] shadow-[0_26px_70px_rgba(0,0,0,0.58)] backdrop-blur-[36px] md:block">
                  <div className="pointer-events-none absolute inset-0 rounded-[24px] bg-[radial-gradient(circle_at_10%_0%,rgba(0,183,255,0.08),transparent_45%)]" />
            ...
            {settingsOpen && (
              <>
                <div
                  ...
                  role="presentation"
                />
                <div className="fixed left-1/2 top-28 z-[8100] hidden w-[420px] max-w-[calc(100vw-2rem)] -translate-x-1/2 md:block">
          ...
          <div className="hidden md:flex items-center gap-6 ml-4">
            {navItems.map((item) => (
              ...
              >
                ...
                <span
                  className={`absolute left-2 right-2 -bottom-1 h-1 rounded-full bg-[linear-gradient(90deg,rgba(0,183,255,0.8),rgba(0,183,255,0.4))] shadow-[0_0_12px_rgba(0,183,255,0.35)] transition-all duration-300 ${
                    activePage === item.id ? 'scale-x-100 opacity-100' : 'scale-x-0 opacity-0'
                  }`}
                />
              </a>
            ))}
          ...
          <div className="ml-auto flex items-center gap-2 md:gap-3">
            ...
            {hasSearchData && (
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-full border px-3 py-2.5 text-xs font-semibold uppercase tracking-[0.1em] transition duration-300 focus:outline-none focus:ring-2 focus:ring-accent/40 sm:px-4 ${
                  searchOpen
            ...
            {isHomepage && (
              <button
                ...
                className={`md:hidden inline-flex h-11 w-11 items-center justify-center transition duration-300 ${
                  sectionsMenuOpen
                    ? 'text-accent'
            ...
            {isHomepage && (
              <div className="relative">
                <button
                  ...
                  className={`hidden md:inline-flex items-center gap-2 rounded-full px-4 py-2.5 text-xs font-semibold uppercase tracking-[0.1em] transition duration-300 focus:outline-none focus:ring-2 focus:ring-accent/40 ${
                    sectionsMenuOpen
            ...
            <div className="relative hidden md:block">
              <button
                ...
                className={`inline-flex h-11 w-11 items-center justify-center rounded-full transition duration-300 ${
                  settingsOpen
                    ? 'text-accent'
                    : 'text-text-secondary hover:text-accent'
                }`}
